...
1. If this is your first time using this web-site, you may get a "Security Exception" warning by your web browser. You can safely ignore this warning and permanently store the certificate. For more information, please see: http://www.inmotionhosting.com/support/website/ssl/self-signed-ssl-certificate-warning
2. Click on the day that you are available - the day will change colour.
