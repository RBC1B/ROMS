...
<div id="stage-${stage.projectStageId}" class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <button type="button" class="btn btn-edifice pull-right">
            <a class="accordion-toggle pull-right" data-toggle="collapse" data-parent="#accordion-stage-${stage.projectStageId}" href="#collapse-stage-${stage.projectStageId}">
                <span class="glyphicon glyphicon-plus"></span>
            </a>
        </button>
        <div class="clearfix"></div>
        <div class="accordion" id="accordion-stage-${stage.projectStageId}">
            <div class="accordion-group">
                <div id="collapse-stage-${stage.projectStageId}" class="accordion-body collapse in">
                    <div class="accordion-inner">
                        <br>
                        <c:choose>
                            <c:when test="${!empty stage.activities}">
                                <h3>Activities</h3>
                                <div id="project-stage-${stage.projectStageId}-activities">
